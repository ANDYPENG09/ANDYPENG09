...
| XRD | **xrd-toolkit** | Showcase hub for three offline, single-file, zero-dependency XRD tools: FileConventor (format conversion), Scherrer (crystallite size), PtCoOrdering (L1₀ ordering degree). | [repo](https://github.com/ANDYPENG09/xrd-toolkit) | v1.1 |
